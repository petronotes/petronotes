...
(function () {
  ...
  // ========== SYNC SCROLL: proportional (editor <-> preview) ==========
    ...
    btnToggleSync.addEventListener('click', function () {
        ...
        btnToggleSync.setAttribute('data-active', syncScrollEnabled ? 'true' : 'false');
        showToast(syncScrollEnabled ? 'Синхронный скролл включён' : 'Синхронный скролл выключен', 'success', 1500);
    });
